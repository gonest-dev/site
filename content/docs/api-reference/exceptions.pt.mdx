...
Todos os construtores aceitam (message string, details ...any). Quando message é "", uma mensagem padrão é usada.

### Erros de Cliente 4xx

| Tipo | Status | Mensagem Padrão |
|---|---|---|
...
gonest.HttpStatus* - todas as 63 constantes padrão 
