---
title: Exceptions
description: HttpException and built-in exception reference
---
...
All constructors accept (message string, details ...any). When message is "", a sensible default is used.

### 4xx Client Errors

| Type | Status | Default Message |
|---|---|---|
...
gonest.HttpStatus* - all 63 standard 
et/http.StatusXxx constants re-exported.
